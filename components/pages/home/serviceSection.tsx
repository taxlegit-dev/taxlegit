  ...
  const governmentRegistrationServices = [
    {
      ...
      description: "The Goods and Services Tax (GST) is a comprehensive indirect tax levied on the manufacture, sale, and consumption of goods and services in India.",
    ...
    },
    {
      ...
      description: "The Government e-Marketplace (GeM) is an online platform established by the Government of India to facilitate procurement.",
    ...
    },
    {
      ...
      description: "Micro, small, and medium enterprises (MSME) form the backbone of the Indian economy with government incentives.",
    ...
    },
    {
      ...
      description: "The Government of India's well-known initiative to support startups with various benefits and recognition.",
    ...
    },
    {
      ...
      description: "A Digital Signature Certificate (DSC) is an electronic form of a signature that validates the identity of the sender.",
    ...
    },
    {
      ...
      description: "Import Export Code (IEC) registration is crucial for businesses in India engaged in international trade.",
    ...
    },
    {
      ...
      description: "PF registration involves enrolling an organization and its workers in India's Employees' Provident Fund scheme.",
    ...
    },
    {
      ...
      description: "Legal Entity Identifier (LEI) registration is a global system designed to uniquely identify legal entities.",
    ...
    },
    {
      ...
      description: "Required for companies involved in manufacturing, packing, importing, and measuring equipment.",
  ...
  const taxFilingServices = [
    {
      ...
      description: "TDS Return Filing Online is crucial for individuals and businesses to ensure compliance with tax regulations.",
    ...
    },
    {
      ...
      description: "As a business owner, you must be well aware of the importance of GST return filing for compliance.",
    ...
    },
    {
      ...
      description: "Income Tax Return (ITR) is a form through which taxpayers declare their taxable income and applicable tax details.",
  ...
  const complianceServices = [
    {
      ...
      description: "Trademark registration is the legal procedure to acquire exclusive rights over brand elements like names and logos.",
    ...
    },
    {
      ...
      description: "Vendor reconciliation is a crucial process in financial management for maintaining healthy business relationships.",
    ...
    },
    {
      ...
      title: "Due Diligence",
      description: "Due diligence stands as an important process for understanding legal, financial, and operational aspects of a business.",
    ...
    },
    {
      ...
      description: "Shop and Establishment Registration is mandatory for every business engaged in commercial activities.",
  ...
  const complianceLicensingServices = [
    {
      ...
      description: "ISO certification helps businesses improve efficiency, productivity, and customer satisfaction.",
    ...
    },
    {
      ...
      description: "FSSAI license registration is mandatory for every food business operator (FBO) in India.",
    ...
    },
    {
      ...
      description: "An ISP license is an official authorization to provide internet services to clients through various technologies.",
  ...
  const intellectualPropertiesServices = [
    {
      ...
      description: "Renewing a trademark in India is crucial for maintaining exclusive rights to your brand name, logo, or slogan.",
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("https://taxlegit.com/assets/img/bg/ser-bg.png")',
          ...
          {currentServices.map((service, index) => (
            ...
            >
              ...
              <div className="relative mb-6">
                <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.color} flex items-center justify-center transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg`}>
